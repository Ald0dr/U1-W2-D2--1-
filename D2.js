...
let numero2= 30
if (numero2 > numero1){
  console.log("numero 2 maggiore di numero 1")}
...
{
  console.log("il costo totale è di " +(totalshoppingcart + 10))
}
...
if (totalshoppingcart2 > 50){
  console.log("il costo totale è di " + (totalshoppingcart2 - (totalshoppingcart2 * 20 / 100)))
}
else {
  console.log("il costo totale è di " +(totalshoppingcart2 + 10))
}
